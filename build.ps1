...
(Get-Content $nuspecpath).replace('<description>A library generated from a Swagger doc</description>', "<description>The most powerful and cost-effective speech recognition and voice AI APIs, continuously updated.</description>") | Set-Content $nuspecpath
...
& C:\CodeSigning\sign.ps1 ./client/src/Cloudmersive.ApiClient.NET.Speech/bin/Debug/Cloudmersive.APIClient.NET.Speech.dll

./nuget.exe pack $csprojpath

(Get-Content ./client/README.md).replace(' automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project', " for the [Cloudmersive Speech and Voice Recognition API](https://cloudmersive.com/voice-recognition-and-speech-api)") | Set-Content ./client/README.md
